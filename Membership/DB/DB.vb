...
Public Class DB
    ...
    Private Shared tables As List(Of Table)
...
#Region "Types"
        ...
        Public Shared ReadOnly [Byte] As New MDBType("UNSIGNED BYTE", OleDbType.UnsignedTinyInt, GetType(Byte))
...
#End Region
    ...
    Public Class Field
        ...
        Public Property AutoIncrement() As Boolean
            Get
                Return ((DataType Is MDBType.Number) AndAlso auto_inc)
            End Get
            Set(value As Boolean)
                auto_inc = value
            End Set
        End Property
        Private auto_inc As Boolean = False
        Public Sub New(name As String, datatype As MDBType, Optional size As Integer = 0)
            Me.Name = name
            Me.DataType = datatype
            Me.Size = size
        End Sub
        Public Function CreateSQL() As String
            Return [String].Format("`{0}` {1}({2}){3}{4}", Me.Name, Me.DataType.SQL, If(Me.Size > 0, Me.Size.ToString(), ""), If(Me.NotNull, " NOT NULL", ""), If(Me.AutoIncrement, "AUTOINCREMENT", ""))
        End Function
    End Class
    Public Class Table
        Public Name As String, PrimaryKey As String
        Public Fields As Dictionary(Of String, Field)
        Public Function CreateSQL() As String
    ...
    Public Class DBList(Of T As DBObject)
        Inherits List(Of T)
#Region "Static"
        Public Shared Function [Select](Optional criteria As String = Nothing) As DBList(Of T)
...
#Region "Instance"
        ...
        Public Sub Insert()
            ...
            For Each field As String In data.Keys
                If field.Equals(table.PrimaryKey) AndAlso table.Fields(table.PrimaryKey).AutoIncrement Then
                    Continue For
                End If
            ...
            cmd.ExecuteNonQuery()
            If table.Fields(table.PrimaryKey).AutoIncrement Then
